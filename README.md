...
2. **One-Shot Wireless Installation**:
   ...
   ./install.sh <CAR_IP>
   ```
   *Provisions `modehelper.apk`, installs `drive_assist.apk`, and launches Drive Assist. It does not change Bluetooth settings or any file under `/system`.*
...
- [Code Quality & Test Coverage Report](docs/CODE-QUALITY-REPORT.md) — JaCoCo test metrics (14.20% scoped instruction coverage / 194 tests), Lint tuning, Checkstyle, and SpotBugs catalog
