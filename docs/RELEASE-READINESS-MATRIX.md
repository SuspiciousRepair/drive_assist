...
4. **Repository Hygiene & Governance (R4)**: The repository adheres to open-source governance best practices with an GPLv3 license, contributor guidelines, Conventional Commits standards, a sanitized gitignore, and an unreleased changelog staging section.
...
| **R3: Docs** | Live Vehicle Connectivity | **GO** | ADB connectivity to an IHU629G was verified. Physical screen size `1920x1080`, density `160` (1.0 factor). Live VHAL property readback confirmed. |
...
| **R3: Docs** | Real Vehicle Screenshots | **GO** | 3 valid 1920x1080 RGBA PNG captures verified via Pillow: `comfort-view.png` (306 KB), `daily-stats.png` (348 KB), `telemetry-settings.png` (132 KB) in `docs/screenshots/`. |
...
| **R4: Governance**| Licensing | **GO** | Official GNU GPL v3.0 (`LICENSE`) created at repository root. |
...
| **R4: Governance**| README & Status Badges | **GO** | `README.md` updated with CI build, JaCoCo coverage (5.55% / 131 tests), License (GPLv3), and Platform (Geely IHU629G / Android 9) status badges, screenshot previews, quickstart, and links. |
